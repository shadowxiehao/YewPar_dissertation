...
其中分为运行时间评估与基于Performance-Driven Workstealing Policy比原来的DepthPool Workstealing Policy的运行速度提升两个部分.
...
\begin{itemize}
    ...
    \item 从应用实现进行研究和测试的具体数据上分析后,
          ...
          基于Depth-Bounded skeleton的Maxclique程序相比其它应用具有更高的性能异常的概率,
          ...
          \end{figure}
          在评估\texttt{maxclique-16}应用的运行时间波动性时,
