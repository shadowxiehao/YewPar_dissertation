...
其中真正负责执行任务的是YewPar的worker,所以如果想要获得各节点的负载情况,就需要获取各节点的worker的负载情况.
我们对worker的工作流程进行了分析,大致如下图\cref{fig:period_of_worker}

\begin{figure}[h]
    \centering % 让图片居中显示
    \includegraphics[width=0.8\textwidth]{images/period_of_worker.pdf} % 插入图片，设置图片宽度为文本宽度的80%
